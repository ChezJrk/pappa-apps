...
pol = 'HH_npy'
directory = './data/AFRL_P2048_S2048/pass1'
...
img_plane = imgTools.img_plane_dict(platform, res_factor = 0.3111, upsample = True, aspect = 1.0)
...
if rank == 0:
    ...
    outfn = "BPmpi_AFRL2K_demo_" + str(count) + ".png"
