...
pol = 'HH_npy'
directory = './data/AFRL_P1024_S1024/pass1'
...
img_plane = imgTools.img_plane_dict(platform, res_factor = 0.6222, upsample = True, aspect = 1.0)
...
if rank == 0:
    ...
    outfn = "BPmpi_AFRL1K_demo_" + str(count) + ".png"
