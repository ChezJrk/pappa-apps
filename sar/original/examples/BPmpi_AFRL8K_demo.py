...
pol = 'HH_npy'
directory = './data/AFRL_P8192_S8192/pass1'
...
img_plane = imgTools.img_plane_dict(platform, res_factor = 0.0777, upsample = True, aspect = 1.0)
...
if rank == 0:
    ...
    outfn = "BPmpi_AFRL8K_demo_" + str(count) + ".png"
